...
<div class="modal-overlay">
	<div class="modal-dialog">
		...
		<div class="modal-dialog__title">Do you want it - just click one like button</div>
		<div class="modal-dialog__desc">After clock on any of social button, you will be able to download all mobile ringtones from use site for free!</div>
		...
		<div class="modal-dialog__timer">       
      <!--Current link: {link}-->
			Please like us or wait <span id="redirect-modal-timer">{timer}</span> seconds.
		</div>
	</div>
</div>
